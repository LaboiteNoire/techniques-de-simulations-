...
\begin{center}
\begin{minipage}[r]{0.6\textwidth}
lorsque $\delta$ est très grand, le \textit{terme oscillant} devient quasiment constant et la densité tends vers une loi normale tronquée. Dans ce cas, la méthode optimisée (\textit{rejet gaussien})
...
Nous ne doutons pas qu'il puisse exister une solution satisfaisante a ce problème, néanmoins ne arrivons petit a petit a court de temps.  
\end{minipage}
\end{center}
