...
Pour ce qui est de la simulation (et des démos) pour les sinistres (excluant $X_{puissance}$), je les ferais par la suite, je fini de paralléliser les calculs du modèle A et B.

J'ai rajouter une partie sur la table de Walker et les questions de complexité.
